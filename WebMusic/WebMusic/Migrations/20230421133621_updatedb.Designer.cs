...
namespace WebMusic.Migrations
{
    ...
    [Migration("20230421133621_updatedb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebMusic.models.ef.Role", b =>
                {
            ...
            modelBuilder.Entity("WebMusic.models.ef.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebMusic.models.ef.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WebMusic.models.ef.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebMusic.models.ef.UserLogin", b =>
                {
            ...
            modelBuilder.Entity("WebMusic.models.ef.UserRole", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WebMusic.models.ef.UserToken", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
